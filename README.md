...
Neuronal synchronization has long been assumed to be a main cause for the shaping of the alpha rhythm **[1]**. While some claimed it to be the footprint of synchronous coupled neuronal generators **[2]** (an idea akin of that of weakly coupled nonlinear oscillators **[3]**), others have noticed that it indeed can be interpreted as a band-pass filter **[4]**, idea later corroborated by Motokawa et al. by approximating the envelope of the alpha rhythm with a Rayleigh distribution **[5]**, demonstrating in this way its band-pass filter characteristics and hence its relation to Gaussian noise **[6]**. Recently, a study by Hidalgo et al. furthered this idea and purposed it as a method to asses the rhythm Gaussianity **[7]**. Here, we extend on this proposal by applying the central idea, that the coefficient of variation of the envelope can be used as marker of rhythm Gaussianity, to study EEG alpha rhytm dynamics in two notoriously different experimental conditions, namely A and B. In what follows, we adapt this approach and extend its scope with different methodological constrains and experimental conditions. 
